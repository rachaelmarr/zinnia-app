    ...
    <div className="w-full flex flex-col gap-2 relative">
      ...
      <div className="relative w-full">
        <input
          type="text"
          className={`
            w-full h-9 px-3 pr-8 rounded-lg bg-white outline outline-1 outline-offset-[-1px]
        ...
        {showClear && hasValue && !readOnly && !disabled && (
          <button
            ...
            type="button"
            className="absolute right-2 top-1/2 -translate-y-1/2 w-5 h-5 flex items-center justify-center rounded-full bg-[#47567B] text-white hover:bg-[#3b4a6c] focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:ring-[#0E7490]"
